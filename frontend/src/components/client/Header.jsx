    ...
    <>
      ...
      <div className={`sidebar ${isSidebarOpen ? 'active' : ''}`}>
        ...
        <ul className="sidebar-menu">
          <li>
            <NavLink to="/" onClick={toggleSidebar} activeClassName="active" exact="true">
              <i className="fa fa-home"></i> Trang chủ
            </NavLink>
          </li>
          <li>
            <NavLink to="/gioi-thieu" onClick={toggleSidebar} activeClassName="active">
              <i className="fa fa-info-circle"></i> Giới thiệu
            </NavLink>
          </li>
          <li>
            <NavLink to="/luat-su" onClick={toggleSidebar} activeClassName="active">
              <i className="fa fa-user"></i> Luật sư
            </NavLink>
          </li>
          <li>
            <NavLink to="/dich-vu" onClick={toggleSidebar} activeClassName="active">
              <i className="fa fa-briefcase"></i> Dịch vụ
            </NavLink>
          </li>
          <li>
            <NavLink to="/tin-tuc" onClick={toggleSidebar} activeClassName="active">
            <i class="fa-solid fa-newspaper"></i> Tin tức & Sự kiện
            </NavLink>
          </li>
          <li>
            <NavLink to="/dan-su" onClick={toggleSidebar} activeClassName="active">
              <i className="fa fa-users"></i> Dân sự
            </NavLink>
          </li>
          <li>
            <NavLink to="/hinh-su" onClick={toggleSidebar} activeClassName="active">
              <i className="fa fa-gavel"></i> Hình sự
            </NavLink>
          </li>
          <li>
            <NavLink to="/hanh-chinh" onClick={toggleSidebar} activeClassName="active">
              <i className="fa fa-university"></i> Hành chính
            </NavLink>
          </li>
          <li>
            <NavLink to="/so-huu-tri-tue" onClick={toggleSidebar} activeClassName="active">
