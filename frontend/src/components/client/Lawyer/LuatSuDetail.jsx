...
import pic_1 from '../../../assets/lawyers/Luat-Su-Vu-Duy-Nam.jpg';
const LuatSuDetail = () => {
    return(
                    ...
                    <div className="luatSuDetailCard-left-body">
                        <div className="chuyenMon">
                            ...
                            <div className="chuyeMon-body">
                                Thạc sĩ luật kinh tế, cử nhân Hàng hải<br/>
                        ...
                        <div className="kinhNghiem">
                            ...
                            -	Hơn 10 năm kinh nghiệm tham gia tranh tụng trong các vụ án dân sự, kinh doanh thương mại, hành chính và hình sự.<br/>
                            -	Đại diện sở hữu công nghiệp trong các lĩnh vực: nhãn hiệu, chỉ dẫn địa lý, tên thương mại, chống cạnh tranh không lành mạnh và bí mật kinh doanh.<br/>
                            -	Tư vấn chuyên sâu về doanh nghiệp, lao động, kinh doanh thương mại, sở hữu trí tuệ, đầu tư, phát triển và mua bán dự án.<br/>
                            -	Chuyên gia đàm phán, soạn thảo và rà soát các hợp đồng thương mại, hợp đồng dân sự, hợp đồng xây dựng, hợp đồng vay, bảo đảm, phát hành trái phiếu, cổ phiếu và mua bán, sáp nhập doanh nghiệp.<br/>
                            </div>
                        </div>
                    </div>
                </div>
