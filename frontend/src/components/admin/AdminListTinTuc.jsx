...
import '../../styles/admin/AdminListTinTuc.scss';
...
const AdminListTinTuc = () => {
  ...
  // Handle Edit button click - changed to use slug instead of id
  const handleEdit = (slug) => {
    navigate(`/admin/edit-tin-tuc/${slug}`);
  };

  // Handle Delete button click - still using id as that's what the backend expects
                ...
                {news.map((item) => (
                  <div className="intro-news__card" key={item._id}>
                    ...
                    <div className="admin-actions">
                      <button className="edit-btn" onClick={() => handleEdit(item.slug)}>
                        Sửa
                      </button>
