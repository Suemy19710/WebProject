...
const AdminDoanhNghiep = () => {
    ...
    const handleImageUpload = async (event) => {
        ...
        try {
            const response = await axios.post('https://luatkimngoc-vn.onrender.com/api/doanh-nghiep/upload-image', formData, {
    ...
    const handlePost = async () => {
        ...
        try {
            const response = await fetch('https://luatkimngoc-vn.onrender.com/api/doanh-nghiep', {
                method: 'POST',
...
export default AdminDoanhNghiep;