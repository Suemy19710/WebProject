...
const AdminHanhChinh = () => {
    ...
    const handleImageUpload = async (event) => {
        ...
        try {
            const response = await axios.post(`${process.env.REACT_APP_API_URL}/hanh-chinh/upload-image`, formData, {
    ...
    const handlePost = async () => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_API_URL}/hanh-chinh`, {
                method: 'POST',
