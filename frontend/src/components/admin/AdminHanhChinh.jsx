...
const AdminHanhChinh = () => {
    ...
    const handleImageUpload = async (event) => {
        ...
        try {
            const response = await axios.post('https://luatkimngoc-vn.onrender.com/api/hanh-chinh/upload-image', formData, {
    ...
    const handlePost = async () => {
        ...
        try {
            const response = await fetch('https://luatkimngoc-vn.onrender.com/api/hanh-chinh', {
                method: 'POST',
