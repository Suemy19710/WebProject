...
const cloudinary = require('cloudinary').v2; // Import cloudinary correctly
...
const createNews = async (req, res) => {
  try {
    ...
    // Validation: Use req.files.image for express-fileupload
    if (!req.body.title || !req.body.content || !req.files?.image) {
...
const deleteNewsById = async (req, res) => {
  try {
    ...
    // No need to delete local file since we're using Cloudinary
